...
import WebOutlet from '../src/Assets/WebOutlet.png';
  ...
  return (
    ...
    >
      ...
      <div className="mobile">
        ...
        <div className="footer__2nd__part">
          <h5>Follow us</h5>
          <Link to="https://www.facebook.com/profile.php?id=100076712525557">
            <h3>Facebook</h3>
          </Link>
          <Link to="/https://www.youtube.com/c/AbhaAcharya">
            <h3>Youtube</h3>
          </Link>
          <Link to="https://www.instagram.com/neebika.k_/">
            <h3>Instagram</h3>
          </Link>
        </div>
        {/* Footer 4th part */}
